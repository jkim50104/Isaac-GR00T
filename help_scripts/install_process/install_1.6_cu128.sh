...
#################################################################################################################################################################
# For RTX PRO 6000 blackwell(sm12.0) we have to rebuild pytorch (The github uv setting compiled pytorch 2.7.0 supports sm_50 sm_60 sm_70 sm_75 sm_80 sm_86 sm_90)
...
pip install torchcodec==0.1.1 # for torch 2.5.1=>0.1.1, torch 2.7.1=>0.5.0
